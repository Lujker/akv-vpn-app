> Archived upstream Hiddify landing page. AKV VPN remains a GPLv3 fork and
> preserves upstream attribution; the current repository README describes the
> AKV-specific product and links back to the upstream project.
